...
videojs.Hls.prototype.selectPlaylist = function () {
  ...
  console.log('Resolution plus one: ' + resolutionPlusOne);
  console.log('Sorted playlist[0] ' +  sortedPlaylists[0]);
  // fallback chain of variant
  console.log(resolutionPlusOne || resolutionBestVariant || bandwidthBestVariant || sortedPlaylists[0]);
