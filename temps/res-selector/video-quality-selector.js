...
(function (_V_) {
    ...
    _V_.ResolutionMenuItem.prototype.onClick = function () {
        this.player().manualOverride = true;
        this.player().currentQuality = this.resolution;

        $('.vjs-menu-content').find('.vjs-selected').removeClass('vjs-selected');
        $(this.el_).addClass('vjs-selected');
